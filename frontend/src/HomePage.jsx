...
function Home() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center w-[100%] bg-gray-50">
             <NavBar/>
            <p className="text-4xl font-semibold pl-2 pt-2 md:font-bold">Welcome back, Dev Astra</p>
            <p className="text-lg text-gray-500 px-2 mt-4"> Discover amazing stories, insights, and ideas from our community of writers.</p>
            <div className=" flex gap-10 justify-around mb-4 mt-3 md:mt-5 ">
                <button className="md:px-10 md:py-4 px-3 py-3 cursor-pointer bg-blue-700 hover:bg-blue-900 shadow-md text-white rounded-md">Write a New Post</button>
                <button className="md:px-10 md:py-4 px-3 py-3 cursor-pointer bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md" >View My Posts</button>
            </div>
            <div className="md:mt-5 flex gap-10 flex-wrap justify-center w-full rounded-lg shadow-lg pl-2 pr-2 md:pb-5">
                {
                    posts.map((post) => (
